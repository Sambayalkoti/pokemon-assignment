...
<body class="bg-black">
    <div class="container">
        <div class="mt-4 mb-5 d-flex justify-content-between align-items-center">
            ...
            <div>
                <i class="fab fa-facebook" style="color: royalblue ; font-size: 35px"></i>
                <i class="fab fa-instagram" style="color: orange; font-size: 35px"></i>
                <i class="fab fa-youtube" style="color: red ;font-size: 35px"></i>
